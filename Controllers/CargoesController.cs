...
namespace GestaoTarefasIPG.Controllers
{
    public class CargoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CargoId,Nome,Nivel")] Cargo cargo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CargoId,Nome,Nivel")] Cargo cargo)
        {
            if (id != cargo.CargoId)
            {
                return NotFound();
